	...
	return (
		<section className="about-bio" ref={bioRef}>
			<article>
				...
				<p>Most recently, I spent 5 years at a small digital agency where I got to work on a pretty wide range of products — shipping component systems, wiring up APIs, and generally obsessing over creating experiences that were interactive and memorable. I learned a ton there and genuinely loved the work and our team.</p>
				<p>I work mainly with <span>React</span>, <span>TypeScript</span>, and <span>JavaScript</span>, but also have experience building on top of WordPress's CMS. I'm also exploring backend technologies like Python and Postgres, with the ambition of growing into a Fullstack Engineer. I care a lot about the space between a beautiful design and a great implementation — getting that right is the part of the job I find most satisfying.</p>
